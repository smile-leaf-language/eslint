...
module.exports = {
    ...
    create(context) {
         ...
         *    For example, an element in an array will have {offset: 1, from: openingCurly} to indicate that it is offset by one indentation
         *    level from the opening curly brace. All the offsets are initialized to 0 at the start.
        ...
        */
        ...
        return {
            ...
            "VariableDeclarator:exit"(node) {
                 ...
                 * parent declaration has more than 2 declarators.
                 */
