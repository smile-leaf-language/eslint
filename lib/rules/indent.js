        ...
        function addElementListIndent(tokens, elements, offset) {
            ...
            */
            ...
            elements.forEach((element, index) => {
                ...
                if (offset === "first") {
                    setDesiredOffset(getFirstTokenByElementsIndex(index), null, getFirstTokenByElementsIndex(0).loc.start.column / indentSize);
                } else {
                    const previousElement = elements[index - 1];
                    const firstTokenOfPreviousElement = previousElement && getFirstTokenByElementsIndex(index - 1);

                    if (previousElement && previousElement.loc.end.line > tokens[0].loc.end.line) {
                        matchIndentOf(firstTokenOfPreviousElement, getFirstTokenByElementsIndex(index));
                    }
                }
            });
